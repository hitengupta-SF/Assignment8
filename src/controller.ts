...
class controller {
    ...
    public async getAll(req:Request, res:Response) {
        ...
        ON role.key = users.role_id ORDER BY id ASC`,
    ...
    public async getUserById(req: Request, res: Response) {
        ...
        LEFT JOIN customer ON customer.id = users.customer_id LEFT JOIN role
        ON role.key = users.role_idy WHERE users.id = $1`,
        [id], (error,result) =>
        {
            if(error)
            {
    ...
    public async createUser(req: Request, res: Response) {
        ...
        pool.query(`INSERT INTO users(firstname,middlename,lastname,email,phone,role,
            address,customer_id) VALUES ($1,$2,$3,$4,$5,$6,$7,$8)`,
    ...
    public async updateUser(req: Request, res: Response) {
        ...
        pool.query(`UPDATE users SET firstname = $1, middlename = $2, lastname = $3, email = $4,
         phone = $5, role = $6, address = $7,customer_id = $8 WHERE id = $9`,
